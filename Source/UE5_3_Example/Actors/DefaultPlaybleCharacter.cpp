...
void ADefaultPlaybleCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ADefaultPlaybleCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADefaultPlaybleCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADefaultPlaybleCharacter::Look);
	}
	else
	{
...
void ADefaultPlaybleCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADefaultPlaybleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADefaultPlaybleCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}
bool ADefaultPlaybleCharacter::GetHasRifle()
{
	return bHasRifle;
}
...
void ADefaultPlaybleCharacter::Heal(float InHealAmount)
{
